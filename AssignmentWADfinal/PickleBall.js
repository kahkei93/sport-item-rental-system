...
const PickleBall = ({navigation,route}) =>{
    ...
    return(
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={styles.container}>
                <ImageBackground
                    source={require('./image/pickleball.jpg')}
                    style={styles.image}
                    >
                    {/*button*/ }
                    <View>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        Rent high-quality plastic pickleballs made for smooth, consistent bounce. Available for both indoor and outdoor games.
                        </Text>
                    </View>
