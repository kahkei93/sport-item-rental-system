...
const PickleballRacket = ({ navigation,route }) => {
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.container}>
          <ImageBackground
            source={require('./image/pickleballracket1.jpg')}
            style={styles.image}
          >
            {/* Back Button */}
            <View>
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.title}>Pickleball Racket</Text>
          </View>

          {/* Description Details */}
          <View style={styles.titleContainer}>
            <Text style={styles.description}>
              Enjoy the game with our lightweight pickleball rackets. Made with durable materials for comfort, grip, and control during every match.
            </Text>
          </View>
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.description}>
              Material: Composite or Polypropylene Core with Fiberglass Surface
              {'\n'}Size: Standard paddle size
            </Text>
          </View>
          ...
          <Text style={styles.selectedText}>
            Selected Date & Time: {selectedDate ? selectedDate.toLocaleDateString() : 'None'} {selectedTime ? selectedTime : 'None'}
          </Text>
...
export default PickleballRacket;
