...
const VolleyBall = ({route,navigation}) =>{
    ...
    return(
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={styles.container}>
                <ImageBackground
                    source={require('./image/volleyball1.jpg')}
                    style={styles.image}
                    >
                    {/*button*/ }
                    <View>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        Rent a durable and high-quality volleyball for your game, training, or event!
                        </Text>
                    </View>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        {'\n'}Size: Official Size 5 (Standard for adult play)
                        </Text>
                    </View>
                    {/*Selection for date*/}
