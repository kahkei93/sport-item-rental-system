...
const Badminton = ({navigation,route}) =>{
...
const timeSlots = [
    ...
    return(
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={styles.container}>
                <ImageBackground
                    source={require('./image/badminton1.jpg')}
                    style={styles.image}
                    >
                    {/*button*/ }
                    <View>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        Perfect for casual matches, training sessions, or events! Rent a complete badminton set that includes quality rackets and shuttlecocks.
                        </Text>
                    </View>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        Included:
                        {'\n'}2 Badminton Rackets
                        {'\n'}2 Shuttlecocks (nylon)
                        {'\n'}Material:
                        {'\n'}Racket: Lightweight aluminum or carbon steel
                        {'\n'}Shuttlecock: Nylon with rubber base
                        </Text>
                    </View>
                    {/*Selection for date*/}
  ...
  onPress={async () => {
    ...
    const newBooking = {
      ...
      item_name: 'Badminton Set', // Keep the item name
      rent_date: selectedDate.toLocaleDateString(), // Keep the selected date
      rent_time: selectedTime, // Keep the selected time
      amount: quantity * 5, // Assume $5 per item
      status: 'pending', // Keep the status
    };
