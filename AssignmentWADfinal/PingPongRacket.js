...
const PingPongRacket = ({navigation,route}) =>{
    ...
    return(
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={styles.container}>
                <ImageBackground
                    source={require('./image/pingpongracket1.jpg')}
                    style={styles.image}
                    >
                    {/*button*/ }
                    <View>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        Get game-ready with our comfortable and easy-to-use ping pong rackets. Designed for control and speed, perfect for both beginners and experienced players.
                        </Text>
                    </View>
