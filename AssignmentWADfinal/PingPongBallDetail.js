...
const PingPongBall = ({navigation,route}) =>{
    ...
    return(
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={styles.container}>
                <ImageBackground
                    source={require('./image/pingpongball1.jpg')}
                    style={styles.image}
                    >
                    {/*button*/ }
                    <View>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        Rent standard-size ping pong balls for your table tennis game. Smooth, lightweight, and great for fast-paced fun. Available in pairs.
                        </Text>
                    </View>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        {'\n'}Type: Indoor or Outdoor (based on availability)
                        </Text>
                    </View>
                    {/*Selection for date*/}
